...
def find_max_depth(processed_df, node_neighborhood):
    ...
    max_depth_df.to_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS1_V22_AllNodes_MaxDepth.csv')
    relative_change_in_depth.to_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS1_V22_AllNodes_RelativeDepth.csv')
...
def find_max_flow(processed_df, node_neighborhood_df):
    ...
    max_flow_df.to_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS1_V22_AllNodes_MaxFlow.csv')
    relative_change_in_flow.to_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS1_V22_AllNodes_RelativeFlow.csv')
...
def find_max_vol(processed_df, node_neighborhood_df):
    ...
    max_vol_df.to_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS1_V22_AllNodes_MaxVolume.csv')
    relative_change_in_vol.to_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS1_V22_AllNodes_RelativeVolume.csv')
...
def find_max_velocty(processed_links_df,link_neighborhood_df):
    ...
    max_veloc_df.to_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/links/SCS1_V22_AllNodes_MaxVelocity.csv')
    relative_change_in_veloc.to_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/links/SCS1_V22_AllNodes_RelativeVelocity.csv')
...
def time_above_curb(processed_nodes_df):
    ...
    #save
    duration_result.to_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS1_V22_AllNodes_DurationOverCurb.csv')
    relative_duration.to_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS1_V22_AllNodes_RelativeDurationOverCurb.csv')
...
if __name__ == "__main__":
    #load processed data
    processed_df = pd.read_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS1_simV22_AllNodes.csv', index_col=[0, 1])
    processed_links_df = pd.read_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/links/SCS1_simV22_AllLinks.csv', index_col=[0, 1])
