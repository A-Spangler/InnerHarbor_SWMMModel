...
def find_max_vol(processed_df, node_neighborhood_df):
    ...
    max_vol_df.to_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/6_27_2023_V22_AllNodes_MaxVolume.csv')
    relative_change_in_vol.to_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/6_27_2023_V22_AllNodes_RelativeVolume.csv')
