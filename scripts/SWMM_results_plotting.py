...
def plot_basedepth_with_hyetograph(processed_nodes_df, rain_df, BE_nodes):
    ...
    ax1.set_title('SCS Type 3 Storm: Broadway East Flood Depths')
    #ax1.legend()
    ax1.grid(axis='y')
    plt.tight_layout()
    #plt.show()
    plt.savefig('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/plots/nodes/SCS3_V22_J329_BaseDepth.png')
...
def plot_flowrt_with_hyetograph(processed_nodes_df, rain_df, scenarios):
    ...
    ax1.set_title('SCS Type 3 Storm: Broadway East Storm Flow')
    ax1.legend(loc='center left')
    ax1.grid(axis='y')
    plt.tight_layout()
    #plt.show()
    plt.savefig('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/plots/nodes/SCS3_V22 flwrt_with_hyetograph_J338S.png')
...
def plot_depth_with_hyetograph(processed_nodes_df, rain_df, scenarios):
    ...
    ax1.set_xlabel('Time of Day')
    ax1.set_ylabel('Flow (cms)')
    ax1.set_title('SCS Type 3 Storm: Broadway East Flood Depth')
    ax1.legend(loc='center left')
    ax1.grid(axis='y')
    plt.tight_layout()
    #plt.show()
    plt.savefig('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/plots/nodes/SCS3_V22 depth_with_hyetograph_J338S.png')
...
def plot_depth_barchart(processed_nodes_df, scenarios):
    ...
    ax1.set_title('SCS Type 3 Storm: Maximum Flood Depth in Broadway East')
    # ax1.legend(loc='center left')
    ax1.grid(axis='y')
    plt.tight_layout()
    #plt.show()
    plt.savefig('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/plots/nodes/SCS3_V22 depth_barchart_J338S.png')
...
def plot_flowrt_barchart(processed_nodes_df, scenarios):
    ...
    ax1.set_title('SCS Type 3 Storm: Maximum Storm Flow in Broadway East')
    # ax1.legend(loc='center left')
    ax1.grid(axis='y')
    plt.tight_layout()
    #plt.show()
    plt.savefig('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/plots/nodes/SCS3_V22 flwrt_barchart_J338S.png')
...
def boxplot_max_depth(max_depth_df):
    ...
    ax1.set_ylabel('Depth (m)')
    ax1.set_title('SCS Type 3 Storm: Maximum Flood Depths Across Baltimore Harbor')
    plt.tight_layout()
    ax1.grid(axis='y')
    #plt.show()
    plt.savefig('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/plots/nodes/SCS3_V22 depth_boxplot_allnodes.png')
...
def boxplot_max_flow(max_flow_df):
    ...
    ax1.set_ylabel('Flow (cms)')
    ax1.set_title('SCS Type 3 Storm: Maximum Flowrate Across Baltimore Harbor')
    plt.tight_layout()
    ax1.grid(axis='y')
    #plt.show()
    plt.savefig('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/plots/nodes/SCS3_V22 flow_boxplot_allnodes.png')
...
def boxplot_relative_depth(relative_depth_df):
    ...
    ax1.set_ylabel('Depth (m)')
    ax1.set_title('SCS Type 3 Storm: Relative Change in Flood Depth')
    plt.tight_layout()
    ax1.grid(axis='y')
    #plt.show()
    plt.savefig('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/plots/nodes/SCS3_V22 Boxplot_RelativeDepth.png')
...
def boxplot_watersheds_relative_depth(relative_depth_df):
    ...
    plt.title('SCS Type 3 Storm: Relative Change in Max Flood Depth')
    plt.legend(title='Neighborhood', bbox_to_anchor=(1.05, 1), loc='upper left')
    plt.xticks(rotation = 90)
    plt.tight_layout()
    plt.grid(axis='y')
    #plt.show()
    plt.savefig('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/plots/nodes/SCS3_V22 WatershedBoxplot_RelativeDepth.png')
...
def boxplot_relative_flow(relative_flow_df):
    ...
    ax1.set_ylabel('Flowrate (cms)')
    ax1.set_title('SCS Type 3 Storm: Relative Change in Flowrate')
    plt.tight_layout()
    ax1.grid(axis='y')
    #plt.show()
    plt.savefig('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/plots/nodes/SCS3_V22 Boxplot_RelativeFlow.png')
...
def boxplot_relative_veloc(relative_veloc_df):
    ...
    ax1.set_title('SCS Type 3 Storm: Relative Change in Flow Velocity')
    plt.tight_layout()
    ax1.grid(axis='y')
    #plt.show()
    plt.savefig('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/plots/links/SCS3_V22 Boxplot_RelativeVelocity.png')
...
def boxplot_relative_duration_above_curb(relative_duration_df):
    ...
    ax1.set_xlabel('Scenario')
    ax1.set_title('SCS Type 3 Storm: Duration of Flooding Above Curb')
    plt.tight_layout()
    ax1.grid(axis='y')
    #plt.show()
    plt.savefig('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/plots/nodes/SCS3_V22 AboveCurb_allnodes.png')
...
def depth_parallelcoord(relative_depth_df):
    ...
    ax1.set_ylabel('Depth (m)')
    ax1.set_title('SCS Type 3 Storm: Relative Improvement of Depth of Flooding')
    ax1.grid(axis='y')
    ...
    plt.tight_layout()
    plt.savefig('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/plots/nodes/SCS3_V22 Relative_ParallelPlot_Depth.svg')
    plt.savefig('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/plots/nodes/SCS3_V22 Relative_ParallelPlot_Depth.png')
...
def volume_parallelcoord(relative_volume_df):
    ...
    ax1.set_title('SCS Type 3 Storm: Relative Improvement in Flood Volume')
    ax1.grid(axis='y')
    ...
    ax1.legend(handles=patches, title='Neighborhood', loc='center left', bbox_to_anchor=(1, 0.5))
    plt.tight_layout()
    plt.savefig('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/plots/nodes/SCS3_V22 Relative_ParallelPlot_Volume.png')
...
def veloc_parallelcoord(relative_veloc_df):
    ...
    ax1.set_title('SCS Type 3 Storm: Relative Change in Flood Velocity')
    ax1.grid(axis='y')

    ax1.legend(title='Neighborhood', loc='center left', bbox_to_anchor=(1, 0.5))
    plt.tight_layout()
    plt.savefig('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/plots/links/SCS3_V22 Relative_ParallelPlot_Veloc.png')
...
if __name__ == "__main__":
    # load dfs
    processed_nodes_df = pd.read_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS3_simV22_AllNodes.csv', index_col=[0, 1])
    max_flow_df = pd.read_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS3_V22_AllNodes_MaxFlow.csv')
    max_depth_df = pd.read_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS3_V22_AllNodes_MaxDepth.csv')
    duration_df = pd.read_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS3_V22_AllNodes_DurationOverCurb.csv')
    relative_depth_df = pd.read_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS3_V22_AllNodes_RelativeDepth.csv').drop(['Unnamed: 0'],axis=1)
    relative_flow_df = pd.read_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS3_V22_AllNodes_RelativeFlow.csv').drop(['Unnamed: 0'],axis=1)
    relative_duration_df = pd.read_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS3_V22_AllNodes_RelativeDurationOverCurb.csv').drop(['Unnamed: 0'],axis=1)
    rain_df = pd.read_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/rainfall/6_27_23_rain_df.csv')
    relative_veloc_df = pd.read_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/links/SCS3_V22_AllNodes_RelativeVelocity.csv').drop(['Unnamed: 0'], axis=1)
    relative_volume_df = pd.read_csv('/Users/aas6791/PycharmProject/InnerHarborSWMM_experiment/processed/nodes/SCS3_V22_AllNodes_RelativeVolume.csv').drop(['Unnamed: 0'], axis=1)
